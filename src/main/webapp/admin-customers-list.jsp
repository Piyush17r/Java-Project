...
<body class="cbp-spmenu-push">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <table class="table">
      ...
      <tbody>
        <%List<Customer> list = CustomerDao.getAllcusCustomers(); %>
      <%for(Customer c:list){ %>
        <tr class="active">
          ...
          <td><%=c.getAddress() %></td>
          <td><%=c.getEmail() %></td>
          <td><a href="admin-seller-edit.jsp?id=<%=c.getId()%>">Edit</a></td>
          <td><a href="admin-seller-delete.jsp?id=<%=c.getId()%>">Delete</a></td>
        </tr>
       <%} %>
      </tbody>
    </table>
