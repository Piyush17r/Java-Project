...
<body class="cbp-spmenu-push">
  ...
  <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/>
						...
						<li>
							...
							<a href="admin-product-list.jsp"><i class="fa fa-th-large nav_icon"></i>Products<span class="nav-badge-btm">  <  </span></a>
						</li>
						<li>
    ...
    <table class="table">
      ...
      <%for(Product p:list){ %>
        <tr class="active">
          ...
          <td><%=p.getSid()%></td>
          <td><img src="image/<%=p.getImage() %>" height="100px" width="100px" class="img-fluid" alt=""></td>
          <td><%=p.getPname()%></td>
          <td><%=p.getPprice()%></td>
          <td><%=p.getPcategory()%></td>
          <td><a href="admin-seller-edit.jsp?id=<%=p.getPid()%>">Edit</a></td>
          <td><a href="admin-seller-delete.jsp?id=<%=p.getPid()%>">Delete</a></td>
        </tr>
       <%} %>
      </tbody>
    </table>
